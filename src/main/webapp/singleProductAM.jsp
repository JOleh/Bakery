...
<div class="maindiv">
    ...
    <div class="imgdiv">
        ...
        <div class="loadfileimg" onclick="FindFile();" title="Загрузка файла">
            <input type="image" src="data:image/png;base64, <%=base64Encoder.encode(image)%>"
                   name="img">
        </div>

        <form target="rFrame" method="POST" enctype="multipart/form-data">
            <div class="loaddiv">
                <input type="file" id="my_hidden_file" accept="image/png" name="loadfile"
                       onchange="LoadFile();">
    ...
    <br><br>
    <div>
                <textarea rows="6" placeholder="<%=resultSet.getString("info")%>"
