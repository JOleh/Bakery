    ...
    <body>
        ...
        <form action="ExitAdminAccount">
            <div class="headerTitle">
                <input type="text" name="companyTitle" id="companyTitle" value="<%=session.getAttribute("nameP")%>">
            </div>
            ...
            <div class="tablediv">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="tel" name="phonenumber" value="<%=resultSet.getString("phonenumber")%>">
                        </td>
                        <td>
