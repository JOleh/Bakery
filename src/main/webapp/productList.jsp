...
<form action="ProductOrder">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="OpenSingleProduct?productlink=<%=resultSet.getInt("id")%>"
                       name="productlink">
    ...
    <div class="navigation">
        ...
        <input type="submit" value="Корзина" name="basket" id="basket">
        <br>
        <form action="EnterFromConsumer">
            <input type="submit" value="Історія замовлень" name="history" id="history">
        </form>
    </div>
</form>
</body>
