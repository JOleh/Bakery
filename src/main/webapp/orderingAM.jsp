...
<div class="maindiv">
    ...
    <div class="tablediv">
        ...
        <%
                ...
                || (int) session.getAttribute("level") == 5) {
        %>
        <div class="refusediv">
            <form action="RefuseProductOrder">
                <input type="submit" value="Відмовити" name="refuse<%=resultSet.getInt("oid")%>" id="refuse">
            </form>
            <br>
        </div>
        <%
        ...
        <div class="dodiv">
            <form action="DoProductOrder">
                <input type="submit" value="Виготовлено" name="do<%=resultSet.getInt("oid")%>" id="done">
            </form>
            <br>
        </div>
        <%
